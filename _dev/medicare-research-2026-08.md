...
|---|---|---|---|---|
| California | Cal. Ins. Code § 10192.11(h) | **PRIMARY** (read direct 2026-08-20) | 60 days from birthday | any insurer, no age cap; carrier must notify 30-60 days ahead — confirmed word-for-word |
| Idaho | IDAPA 18.04.10 (per doi.idaho.gov's own summary; underlying statute § 41-4404(3)(k) only grants rulemaking authority) | OFFICIAL-SUMMARY (read direct 2026-08-20) | 63 days from birthday | any insurer; new plan effective 1st of month after birthday month — confirmed exactly via Idaho DOI's own page |
| Oregon | OAR 836-052-0143(2) | **PRIMARY** (read direct 2026-08-20) | 30 days before–30 after | any insurer — confirmed word-for-word; doesn't apply to policies issued before 1990 |
| Nevada | Nev. Rev. Stat. § 687B.352(1) (AB 250) | **PRIMARY** (read direct 2026-08-20) | 60 days from birthday month | same insurer's other offerings — confirmed exactly ("made available by the insurer") |
| Wyoming | Wyo. Ins. Reg. Ch. 35 (DOI Bulletin 06-2025) | OFFICIAL-SUMMARY | 63 days from birthday | eff. Jun 4, 2025. Checked 2026-08-20: § 35-12 specifically ("Guaranteed Issue for Eligible Persons") is Wyoming's federal-baseline codification (same shape as WA § 48.66.055), NOT the birthday rule — ruled out as a candidate citation. The actual new section added by the 2025 rulemaking wasn't located directly. |
...
| Indiana | Ind. Code § 27-8-13-9.3, as amended by HEA 1260 (2026) | OFFICIAL-SUMMARY (pre-amendment text read direct 2026-08-20; amended version not reached) | 31 before–31 after | same lettered plan, **must switch to a genuinely different issuer** (mandatory, not merely permitted as previously described); **AGE 65+ ONLY — a real gap, this entry previously had no age restriction at all**; new policy effective 1st of month at least 30 days after signature; eff. Mar 15, 2026 |
| Louisiana | La. R.S. 22:1112(A) | **PRIMARY** (read direct 2026-08-20) | 63 days from birthday | same issuer or affiliate only (affiliate added 2023) — confirmed word-for-word. Statute's subsection B separately covers people losing employer coverage without prior Medigap, but ties itself explicitly to plans "for which federal law currently provides a guaranteed issue right" — reads as a state restatement of the federal baseline, not a new state-added right, so not encoded separately. |
